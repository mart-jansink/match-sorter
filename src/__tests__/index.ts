...
const tests: Record<string, TestCase> = {
  ...
  'can handle object with an array of values with nested keys with a specific index': {
    input: [
      [
        {aliases: [{name: {first: 'baz'}},{name: {first: 'foo'}}]},
        {aliases: [{name: {first: 'foo'}},{name: {first: 'bat'}}]},
    ...
    output: [{aliases: [{name: {first: 'baz'}},{name: {first: 'foo'}}]}],
  },
  'can handle object with an array of values with nested keys with an explicit wildcard': {
    ...
    output: [{aliases: [{name: {first: 'baz'}},{name: {first: 'foo'}}]}, {aliases: [{name: {first: 'foo'}},{name: {first: 'bat'}}]}],
  },
